...
- En **Site settings** → **Domain management**, puedes cambiar el subdominio gratuito de Netlify (ej. `conectoma-ingenia2026.netlify.app`) o conectar un dominio propio de la universidad si lo tienes disponible (ej. `ingenia.usantotomas.edu.co`, requiere configurar DNS).
